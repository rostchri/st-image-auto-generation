...
async function generateViaComfyUiWorkflows(prompt) {
    ...
    try {
        ...
        // Server-Plugin v0.4.0+ liefert {image: "user/images/..."} (slim
        // response — base64-Decoding + Disk-Save passieren bereits
        // backend-side). Aelterer Plugin-Stand → {images: [base64]}, dann
        // fallback auf saveBase64AsFile im Browser.
